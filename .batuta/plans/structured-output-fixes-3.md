...
## Tasks
- [ ] 1. The decode writer is bounded and drops a line whose write failed — backend/medium
...
- [ ] 2. Qualification docs separate launch matching from session checks — docs/low
