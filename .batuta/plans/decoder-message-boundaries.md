...
Scope widened on 2026-09-25 after delivery `decoder-message-boundaries-20260925-194313` stopped on it: the claude error fixtures' want texts carry the synthetic assistant message, which now ends with a newline too.
...
- [ ] 1. Complete-message events end with a newline; streamed deltas are joined as they are — backend/high
      Scope: executor/decode.go, executor/decode_test.go, executor/testdata/stream/*.want.json, executor/testdata/stream/errors/*.want.json
