...
## Tasks
- [ ] 1. The output tail is redacted before it is cut to 4096 bytes — backend/medium
...
- [ ] 2. The usage proof fails if Outcome reads more than the last 20 lines — testing/medium
