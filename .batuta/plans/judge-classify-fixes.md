...
## Tasks
- [ ] 1. First-attempt outcome sees an escalation after a same-executor retry — backend/medium
...
- [ ] 2. Bench tests prove the requests carry neither label nor journal content — testing/medium
      Depends on: 1
...
- [ ] 3. docs/judge.md describes classify as built — docs/low
      Scope: docs/judge.md
