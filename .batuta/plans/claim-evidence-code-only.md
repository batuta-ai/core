...
- [ ] 1. Code settlement runs whenever the decision is on, judge or not — backend/high
      Scope: loop/judgment.go, loop/judgment_test.go, loop/loop_test.go
